...
CHECKPOINTS_NETG_PATH='/home/fanghao/Documents/PIFu/checkpoints/pifu_test_2g_s/netG_latest'
#CHECKPOINTS_NETC_PATH='./checkpoints/net_C'

TEST_FOLDER_PATH='/home/fanghao/Documents/PIFu/sample_images'

# command
CUDA_VISIBLE_DEVICES=${GPU_ID} python /home/fanghao/Documents/PIFu/apps/eval.py \
    --name ${NAME} \
